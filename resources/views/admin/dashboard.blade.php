          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block ">
                ...
                {{--<li><a href="listings.blade.php">Ads</a></li>--}}
                {{--<li class="has-children">--}}
                  {{--<a href="about.blade.php">A Propos</a>--}}
                  {{--<ul class="dropdown">--}}
                ...
                <li class="ml-xl-3 login"><a href="../login.blade.php"><span class="border-left pl-xl-4"></span>Log In</a></li>
                <li><a href="../register.blade.php">Register</a></li>

                <li><a href="#" class="cta"><span class="bg-primary text-white rounded">+ Creer Votre Publication</span></a></li>
              </ul>
            </nav>
          </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <div class="select-wrap">
                      <span class="icon icon-room"><span class="icon-keyboard_arrow_down"></span></span>
                  ...
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <div class="select-wrap">
                      ...
                      <select class="form-control rounded" name="" id="">
                        ...
                        <option value="">Locaux &amp; espaces commerciaux</option>
                        <option value="">Autres</option>
                      </select>
                    </div>
                  </div>
        ...
        <div class="row align-items-stretch no-gutters">
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              ...
              <span class="caption mb-2 d-block">Chambre</span>
          ...
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              <span class="icon"><span class=" flaticon-house"></span></span>
              <span class="caption mb-2 d-block">Studios</span>
          ...
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              <span class="icon"><span class="flaticon-house"></span></span>
              <span class="caption mb-2 d-block">Appartement</span>
          ...
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              <span class="icon"><span class="flaticon-house"></span></span>
              <span class="caption mb-2 d-block">Bureau</span>
              <span class="number">32,891</span>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              <span class="icon"><span class="flaticon-house"></span></span>
              <span class="caption mb-2 d-block">Locaux &amp; Espaces commerciaux</span>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h1 class="font-weight-light text-primary"> Les Annonces V I P</h1>
            <p class="color-black-opacity-5">Booster aussi votre annonce ici</p>
          </div>
        </div>
          ...
          {{--<div class="col-12  block-13">--}}
            {{--<div class="owl-carousel nonloop-block-13">--}}
              ...
              {{--<div class="d-block d-md-flex listing vertical">--}}
                {{--<a href="listings-single.blade.php" class="img d-block" style="background-image: url('images/img_1.jpg')"></a>--}}
                {{--<div class="lh-content">--}}
                  {{--<span class="category">Cars &amp; Vehicles</span>--}}
                  {{--<a href="#" class="bookmark"><span class="icon-heart"></span></a>--}}
                  {{--<h3><a href="listings-single.blade.php">Red Luxury Car</a></h3>--}}
              ...
              {{--<div class="d-block d-md-flex listing vertical">--}}
                {{--<a href="listings-single.blade.php" class="img d-block" style="background-image: url('images/img_2.jpg')"></a>--}}
                {{--<div class="lh-content">--}}
                  {{--<span class="category">Real Estate</span>--}}
                  {{--<a href="#" class="bookmark"><span class="icon-heart"></span></a>--}}
                  {{--<h3><a href="listings-single.blade.php">House with Swimming Pool</a></h3>--}}
                  {{--<address>Don St, Brooklyn, New York</address>--}}
                  {{--<p class="mb-0">--}}
                    {{--<span class="icon-star text-warning"></span>--}}
                    {{--<span class="icon-star text-warning"></span>--}}
              ...
              {{--<div class="d-block d-md-flex listing vertical">--}}
                {{--<a href="listings-single.blade.php" class="img d-block" style="background-image: url('images/img_3.jpg')"></a>--}}
                {{--<div class="lh-content">--}}
                  {{--<span class="category">Furniture</span>--}}
                  {{--<a href="#" class="bookmark"><span class="icon-heart"></span></a>--}}
                  {{--<h3><a href="listings-single.blade.php">Wooden Chair &amp; Table</a></h3>--}}
                  {{--<address>Don St, Brooklyn, New York</address>--}}
                  {{--<p class="mb-0">--}}
                    {{--<span class="icon-star text-warning"></span>--}}
                    {{--<span class="icon-star text-warning"></span>--}}
              ...
              {{--<div class="d-block d-md-flex listing vertical">--}}
                {{--<a href="listings-single.blade.php" class="img d-block" style="background-image: url('images/img_4.jpg')"></a>--}}
                {{--<div class="lh-content">--}}
                  {{--<span class="category">Electronics</span>--}}
                  {{--<a href="#" class="bookmark"><span class="icon-heart"></span></a>--}}
                  {{--<h3><a href="listings-single.blade.php">iPhone X gray</a></h3>--}}
                  {{--<address>Don St, Brooklyn, New York</address>--}}
                  {{--<p class="mb-0">--}}
                    {{--<span class="icon-star text-warning"></span>--}}
                    {{--<span class="icon-star text-warning"></span>--}}
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">NOS ANNONCES</h2>
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-lg-6">
        ...
        <div class="col-12 text-center mt-4">
          <a href="#" class="btn btn-primary rounded py-2 px-4 text-white ">Voir toutes les annonces</a>
        </div>
